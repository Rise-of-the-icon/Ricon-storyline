export const ATHLETES = [
  {
    ...
    moments:[
      {y:"1984",era:"The Beginning",type:"draft",title:"Drafted 3rd Overall by Chicago",body:"The Bulls select a 21-year-old from North Carolina with the third pick. Sam Bowie goes second. Nobody in the arena understands what has just happened to professional basketball — but the game will spend the next two decades catching up.",src:"NBA Draft Records, 1984",media:[{title:"Draft Night Archive",meta:"1984 · Source footage placeholder"},{title:"Rookie Arrival",meta:"1984 · Broadcast placeholder"}]},
      {y:"1986",era:"The Rising",type:"record",title:"63 Points in the Garden",body:"A double-overtime playoff masterpiece against the Celtics. A playoff record that will outlive us all. After the game, Larry Bird looks at the floor and says: \"That was God disguised as Michael Jordan.\" It is not a compliment. It is a confession.",src:"ESPN Archives · Boston Globe, April 1986",media:[{title:"63 in Boston",meta:"1986 · Game footage placeholder"}]},
