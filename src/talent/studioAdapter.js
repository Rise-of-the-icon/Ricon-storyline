...
export function studioProfileToTalentPack(profile, overrides = {}) {
  ...
  return {
    ...
    twin: {
      available: true,
      modes: ["narrator", "ask"],
      askCtaLabel: `Ask ${name} a question`,
    ...
    statusCopy: {
      idle: "Ready from verified timeline material",
      ...
      uncertain: "Outside verified material",
    ...
    copy: {
      empty: `This is an AI-assisted twin grounded in ${name}'s approved timeline. Ask about a verified moment. If the material does not cover it, the twin will say so.`,
      disclose: `Responses are AI-generated from ${name}'s verified timeline. Voice and streaming are simulated preview behaviors.`,
      composerPlaceholder: `Ask ${name} about a verified moment…`,
