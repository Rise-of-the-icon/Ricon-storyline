...
const waltPack = {
  ...
  copy: {
    empty: "Grounded in Walt's June 19 interview and the timeline above. Ask about the music, the business, the AI, or the twin consent story — if the material doesn't cover it, the twin will say so.",
    disclose: "Responses are generated from Walt's verified interview and timeline with live twin voice.",
    composerPlaceholder: "Ask about the music, the business, the AI…",
    ...
    chatEyebrow: "",
    footer: "Context from the June 19 interview · live Inworld voice",
